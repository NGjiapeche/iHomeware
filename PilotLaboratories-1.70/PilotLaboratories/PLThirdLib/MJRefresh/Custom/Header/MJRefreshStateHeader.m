...
- (void)setLastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey
{
    ...
    if (lastUpdatedTime) {
        ...
        // 3.显示日期
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Last updated：%@", nil),time];
    } else {
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:NSLocalizedString(@"Last updated：No records", nil)];
    }
}
